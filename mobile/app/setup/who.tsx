 ...
 * account either way, it belongs to the person practicing, and a family
...
export default function Who() {
  ...
  return (
    ...
    >
      <RekallaSays avatarSize={76}>Who is this for?</RekallaSays>

      <Hint>
        This only changes the wording. Nothing else.
      </Hint>
      ...
      <View style={{ gap: space(4) }}>
        ...
        />
        <ChoiceRow
          label="I'm setting it up for someone"
          sublabel="You'll add things for them"
